function [T,ret] = measureSingleEarFromField(fsI,toMeasure,downsample,dR,CHUNK,filterValue)
    %{
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    About:      
    ...
    try
        ...
        if filterValue > 0
            ...
            h = fspecial('average',[filterValue 1]);
            ufT = imfilter(ufT,h);
        end
        % find period via first peak finding
        [T,f] = findKernelPeriod(ufT,2*dR+1,30,3);
