function [finalScore,nX,rawX] = detectEmergence_ver3(FileList,emergenceNet,frameNetCourse,frameNetFine,nsz,zU1,zE1,zL1,zERR1,zU2,zE2,zL2,zERR2,kidx,GMM)
    try
...
%%%%%%%%%%%%%%%%%%%%%
        ...
        fprintf(['fileName-1: ' FileList{1} '\n']);
        fprintf(['fileName-2: ' FileList{2} '\n']);
        fprintf(['fileName-3: ' FileList{end-1} '\n']);
        fprintf(['fileName-4: ' FileList{end} '\n']);
        fprintf('Reporting first two and last two file names\n');
        fprintf(['******************************************************\n']);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % reporting
...
%%%%%%%%%%%%%%%%%%%%%
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        timeSeries = 1:1:framesToMeasure;
        [finalScore,nX,rawX] = cropTimeSeriesFromRectified_ver4(FileList,boundingBox,timeSeries,tform,'',emergenceNet,frameNetCourse,frameNetFine,nsz,zU1,zE1,zL1,zERR1,zU2,zE2,zL2,zERR2,kidx);
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % crop and measure each cell
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%
