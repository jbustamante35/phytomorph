function [centers,uBBSZ,RxC,imageSZ,BOXSZ] = getCenters_singulated(fileName,mainBOX)
    try
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % read the image
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %{
        % count removed due to large variance in object size etc
        ...
        S2 = imfilter(S2,fspecial('disk',21),'replicate');
