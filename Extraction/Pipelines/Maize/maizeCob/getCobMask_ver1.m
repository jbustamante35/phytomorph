function [Mask_out] = getCobMask_ver1(I,defaultAreaPix,colRange1,colRange2,fill)
    ...
    try
        ...
        % mike white and I spoke on Jan 25, 2019 at the library bar
        % before too many beers, we choose to add in the imclearborder line
        % this should remove the yellow envolpe
        Mask_out = imclearborder(Mask_out);
        % bw large of three objects
