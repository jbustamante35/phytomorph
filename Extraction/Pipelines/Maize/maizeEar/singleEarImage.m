function [KernelLength sM] = singleEarImage(fileName,noe,oPath,rPath,rawImage_scaleFactor,checkBlue_scaleFactor,defaultAreaPix,addcut,baselineBlue,fill,CHUNK,windowSize,toSave,toDisplay)
    ...
    try
        ...
        gridSites = 10;
        [KernelLength,FT,BB,S,MT,~,earColor] = measureKernelLength(I,noe,windowSize,gridSites,defaultAreaPix,fill,CHUNK);
        ...
        if toSave
            ...
            fileList{5} = [oPath nm '_earColor.csv'];
            csvwrite(fileList{5},earColor);
            %%%%%%%%%%%%%%%%%%%%%%%%%
