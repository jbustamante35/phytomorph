function [T ufT BB PS MT sM earColor] = measureKernelLength(I,numberCobs,RAD,gridSites,defaultAreaPix,fill,CHUNK)
    %{
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    About:      
    ...
    try        
        ...
        for e = 1:numberCobs
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % add color for ears - addie on feb 22, 2019
            colorImage = imresize(grayImage,size(subI));
            fidx = find(subI);
            for k = 1:3
                tmp = colorImage(:,:,k);
                earColor(e,k) = mean(tmp(fidx));
            end
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
