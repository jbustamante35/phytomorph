function [res] = TIPS_noBackground_verCondor( img, oPath, tree ,Mdl,params )
    res = true;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % created
    if nargin < 5;params = [ 0.08, 200, 55, 15, 10e-8, 75, 301, .2 ];end
    P = nameParams(params);
    reSZ = 10; % resizing parameter - work into param list later...
    boxExpansion = 0.5; % Same with this parameter...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    try
        ...
        [tasselMask,tasselImage] = getTasselMask_verCondor(img,10,Mdl,tree,oPath);
