function [rI,angle,msg,qrCropBox] = rectifyImage_ver3(I,QRreSZ,qrCropBox,debug)
    try
        qrCropBox = [];
        % set defaults
        ...
        floorCHOP = 30;
        % read the crop box
        fprintf(['Using QR box:' num2str(qrCropBox) '\n'])
        [msg,qrCropBox] = getQRcode_3(I,qrCropBox,QRreSZ);
        fprintf(['Found QR box:' num2str(qrCropBox) '\n'])
        ...
        getReport(ME)
        fprintf(['Failed on rectifyImage.Version 3.\n']);
    end
end