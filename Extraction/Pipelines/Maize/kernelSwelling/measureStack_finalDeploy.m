function [S A rowCount dB C] = measureStack_finalDeploy(Stack,BOX,oPath,disp)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % get the centers of the kernels, realign, and get row count
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % get centers
...
%{
    ...
    % remote test
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    target = '/mnt/spaldingdata/nate/scannerJunk/';
    source = '/iplant/home/jgustin/maizeData/kernel_swellData/20190927_Scanner1%'
    imassDownload(source,target,'tiff',12);
    FilePath = target;
    FileList = {};
    FileExt = {'tiff'};
    FileList = gdig(FilePath,FileList,FileExt,1);
    [S A rowCount dB C] = measureStack_finalDeploy(FileList,[200 200 200 200],'./output/',0);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
