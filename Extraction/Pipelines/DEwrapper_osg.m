function [] = DEwrapper_osg(functionName,varargin)
    ...
    if toR('01-Apr-2019')
        ...
        if ~OSG
            ...
            setenv('LD_LIBRARY_PATH', [pwd '/../../codebase/o/common_dependencies/exe/lcms/lib/x86_64-linux-gnu/:' getenv('LD_LIBRARY_PATH') pwd '/../../codebase/o/common_dependencies/exe/lcms/lib/']);
            %[r,q] = system(CMD,'-echo');
           ...
           %} 
            ...
            % restore path
            setenv('LD_LIBRARY_PATH', [OLD_PATH ':' pwd '/../../codebase/o/common_dependencies/exe/lcms/lib/']);
            fprintf(['LD_LIBRARY_PATH IS:\n']);
            CMD = 'echo $LD_LIBRARY_PATH';
            [r,q] = system(CMD,'-echo');
            
            if isdeployed
                javaaddpath([pwd '/../../codebase/o/common_dependencies/misc'])
