classdef funcK < basisT
    ...
    methods
        ...
        function [obj] = funcK(P,T,globData,funcT)
            if nargin == 2;globData = [];end
            % init the sub class
            obj = obj@basisT(P,T,[]);
            % set the glob data
        ...
        function [F] = f(this,x,layer)
            if nargin == 2;layer = 1:size(this.globData,3);end
